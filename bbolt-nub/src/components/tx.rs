...
use crate::common::errors::{IOError, PageError, TxError};
  ...
  TX: TxReadLazyPageIO<'tx>,
{
  delegate! {
      to self.tx {
      fn read_freelist_overflow(&self, freelist_page_id: FreelistPageId, overflow: u32) -> crate::Result<<Self::TxPageType as TxPageType<'tx>>::TxPageBytes, IOError>;
      fn read_node_overflow(&self, node_page_id: NodePageId, overflow: u32) -> crate::Result<<Self::TxPageType as TxPageType<'tx>>::TxPageBytes, IOError>;
      }
  }
}
