...
pub fn find_full<'a, TT: 'a, TP: 'a>(
  text: &'a TT, pattern: &'a TP, bad_char_shift_map: &BMCharacterBadCharShiftMap, limit: usize,
) -> Vec<usize>
where
...
pub fn rfind_full<'a, TT: 'a, TP: 'a>(
  text: &'a TT, pattern: &'a TP, bad_char_shift_map: &BMCharacterBadCharShiftMapRev, limit: usize,
) -> Vec<usize>
where
  TT: Index<usize, Output = char> + LenTrait + ?Sized,
  &'a TT: IntoIterator<Item = &'a char>,
